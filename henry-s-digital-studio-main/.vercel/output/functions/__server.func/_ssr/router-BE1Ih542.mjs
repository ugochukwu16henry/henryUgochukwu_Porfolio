...
const appCss = "/assets/styles-C9moyutF.css";
...
const $$splitComponentImporter$1 = () => import("./dashboard-vNgdmDk2.mjs");
...
const $$splitComponentImporter = () => import("./index-BUV80sQK.mjs");
