...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DbApQkiF.mjs");
...
const manifest = {
  "7abefc919ff69cbf99252c20598241414d8450bfa308a740b01b002d762a0c38": {
    ...
    importer: () => import("./portfolio.functions-B7lEOMMD.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-mef_sxvf.mjs").then((n) => n.r),
