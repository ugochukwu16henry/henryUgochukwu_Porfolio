...
/** Primary resume URL (also kept at legacy path for old links). */
export const resumePdf = "/resume/henry-ugochukwu-resume-2026.pdf";
export const resumePdfLegacy = "/HenryUgochukwu_resumeMay2026.pdf";
